      ...
      <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50 dark:bg-gray-600 dark:text-gray-200">
          <tr>
           ...
           <th scope="col"
           class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-200 uppercase tracking-wider"> Title </th>      
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          <tr>
          <?php
$parse = parse_url($link->original_url);
$title=$parse['host']; 
?> 
            ...
            <td id="short" class="px-6 py-4 whitespace-nowrap">{{$title}}</td>
                 </td>
          @endforeach
          <!-- More items... -->
        </tbody>
